...
base_filename = '/media/ssd-daten/dropevaporationESI/size10/constH_9Loss_1.0C/VTK/constH_9Loss_1.0C_'
...
for value in range(0, 24400, 400):
    ...
    # export view
    export_filename = f'/media/ssd-daten/dropevaporationESI/size10/constH_9Loss_1.0C/fieldData/time_{value}.csv'
