...
{
    defineTypeNameAndDebug(evaluateFlux_0_936H, 0);
    addToRunTimeSelectionTable(functionObject, evaluateFlux_0_936H, dictionary);
}
}
...
Foam::functionObjects::evaluateFlux_0_936H::evaluateFlux_0_936H
(
    const word& name,
    const Time& runTime,
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void Foam::functionObjects::evaluateFlux_0_936H::calculateInitConc()
{
    Info << "Running initial concentration caluclation in the FO evaluateFlux_0_936H" << endl;
    Info << " " << endl;
...
void Foam::functionObjects::evaluateFlux_0_936H::calculateConcInTime()
{
    Info << "Running flux and concentration caluclation in the FO evaluateFlux_0_936H" << endl;
...
bool Foam::functionObjects::evaluateFlux_0_936H::read(const dictionary& dict)
{
    calculateInitConc();
    return true;
}
...
bool Foam::functionObjects::evaluateFlux_0_936H::execute()
{
    calculateConcInTime();
    return true;
}
...
bool Foam::functionObjects::evaluateFlux_0_936H::end()
{
    return true;
}


bool Foam::functionObjects::evaluateFlux_0_936H::write()
{
    return true;
}
