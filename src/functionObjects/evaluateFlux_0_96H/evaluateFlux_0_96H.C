...
{
    defineTypeNameAndDebug(evaluateFlux_0_96H, 0);
    addToRunTimeSelectionTable(functionObject, evaluateFlux_0_96H, dictionary);
}
}
...
Foam::functionObjects::evaluateFlux_0_96H::evaluateFlux_0_96H
(
    const word& name,
    const Time& runTime,
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void Foam::functionObjects::evaluateFlux_0_96H::calculateInitConc()
{
    Info << "Running initial concentration caluclation in the FO evaluateFlux_0_96H" << endl;
    Info << " " << endl;
...
void Foam::functionObjects::evaluateFlux_0_96H::calculateConcInTime()
{
    Info << "Running flux and concentration caluclation in the FO evaluateFlux_0_96H" << endl;
...
bool Foam::functionObjects::evaluateFlux_0_96H::read(const dictionary& dict)
{
    calculateInitConc();
    return true;
}
...
bool Foam::functionObjects::evaluateFlux_0_96H::execute()
{
    calculateConcInTime();
    return true;
}
...
bool Foam::functionObjects::evaluateFlux_0_96H::end()
{
    return true;
}


bool Foam::functionObjects::evaluateFlux_0_96H::write()
{
    return true;
}
